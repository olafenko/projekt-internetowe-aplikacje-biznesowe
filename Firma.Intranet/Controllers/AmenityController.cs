...
namespace Firma.Intranet.Controllers
{
    public class AmenityController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IsActive")] Amenity amenity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IsActive")] Amenity amenity)
        {
            if (id != amenity.Id)
            {
                return NotFound();
