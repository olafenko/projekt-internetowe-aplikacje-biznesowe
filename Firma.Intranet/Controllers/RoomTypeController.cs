...
namespace Firma.Intranet.Controllers
{
    public class RoomTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,MaxGuests,BedCount,Area,Description,IsActive")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,MaxGuests,BedCount,Area,Description,IsActive")] RoomType roomType)
        {
            if (id != roomType.Id)
            {
                return NotFound();
