...
namespace Firma.Intranet.Controllers
{
    public class PageController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,LinkTitle,Content,Position,IsActive")] Page page)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,LinkTitle,Content,Position,IsActive")] Page page)
        {
            if (id != page.Id)
            {
                return NotFound();
